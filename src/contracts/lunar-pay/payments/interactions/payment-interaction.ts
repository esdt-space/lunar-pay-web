...
import { PaymentInteractionOptions } from "../types";
...
export async function paymentInteraction(options: PaymentInteractionOptions) {
  ...
  return sendTransactionWithWatcher(transaction, {
    ...
    successMessage: 'Finished creating payment',
  })
}

function getAmountParameter(amount: PaymentInteractionOptions['amount'], token: PaymentInteractionOptions['token']) {
